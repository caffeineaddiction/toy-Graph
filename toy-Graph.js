...
(function() {
  var foo, foobar, i, tData, toyGraph, _i;
  ...
  toyGraph = (function() {
    ...
    toyGraph.prototype.draw = function(aData, aColor) {
      var aData_Avg, aData_Max, aData_Min, idx, idxi, local_Max, local_Min, local_mod, n, tCurrent, tX, tY, _i, _j, _len, _len1;
      aData_Min = 0;
      aData_Max = 0;
      aData_Avg = 0;
      ...
      this.context.moveTo(idx, ((-aData[0] * this.Graph_Y_Max) / local_Max) + this.Graph_Y_Max + (this.Graph_Y_Min / 2));
      for (_j = 0, _len1 = aData.length; _j < _len1; _j++) {
        n = aData[_j];
        this.context.lineTo(idx, ((-n * this.Graph_Y_Max) / local_Max) + this.Graph_Y_Max + (this.Graph_Y_Min / 2));
        idx += idxi;
      }
